...
export const routes: Routes = [
    ...
    { path: 'newsletters/may-jun-2026', loadComponent: () => import('./pages/newsletters/newsletter-may-jun-2026/newsletter-may-jun-2026').then(m => m.NewsletterMayJun2026Component) },
    { path: 'newsletters/jul-2026', loadComponent: () => import('./pages/newsletters/newsletter-jul-2026/newsletter-jul-2026').then(m => m.NewsletterJul2026Component) },
    { path: 'newsletters/aug-2026', loadComponent: () => import('./pages/newsletters/newsletter-aug-2026/newsletter-aug-2026').then(m => m.NewsletterAug2026Component) },
