...
@Component({
    selector: 'app-ikshanaa-jun-2026',
    standalone: true,
    imports: [CommonModule, ReactiveFormsModule, RouterLink],
    templateUrl: './ikshanaa-jun-2026.component.html',
    styleUrls: ['./ikshanaa-jun-2026.component.scss']
})
export class IkshanaaJun2026Component {
    ...
    async onSubmit() {
        ...
        const templateParams = {
            ...
            message: `
        New Registration for Ikshanaa (Monsoon Edition):
        -----------------------------
        Name: ${formVal.name}
        Age: ${formVal.age}
        Gender: ${formVal.gender}
